...
<form class="layui-form" action="modifyreader" method="post">
    <div class="layui-form-item">
        <label class="layui-form-label">请输入要修改的账号</label>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">新最多可借书数</label>
        <div class="layui-input-inline">
            <input type="text" name="book_borrow_max" required  lay-verify="required" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">新最大可续借次数</label>
        <div class="layui-input-inline">
            <input type="text" name="renew_max" required  lay-verify="required" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">新可借时间(月)</label>
        <div class="layui-input-inline">
            <input type="text" name="time_available" required  lay-verify="required" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">新住址</label>
        <div class="layui-input-inline">
