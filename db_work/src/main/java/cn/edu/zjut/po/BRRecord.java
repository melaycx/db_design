...
public class BRRecord {
    ...
    java.sql.Date borrowed_time;
    java.sql.Date return_time;
    long renew;
    String book_id;
    String out_operator;
    ...
    public BRRecord(long id, String reader_account, Date borrowed_time, Date return_time, long renew, String book_id, String out_operator, Date deadline, long out_or_in, String in_operator) {
        this.id = id;
